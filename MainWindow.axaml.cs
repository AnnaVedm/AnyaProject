...
namespace AnyaProject
{
    ...
    {
        private string SoundPath = @"C:\Users\dlyau\OneDrive\Desktop\AnyaProject\Sounds\prologue.wav";
        ...
        private async void VoitiVAkkaynt(object sender, RoutedEventArgs e)
        {
            ...
            if (!string.IsNullOrWhiteSpace(Name.Text)) //Если строка непустая, то проверяем наш список на наличие этих полей
            {
                ...
                if (proverka != null)
                {
                    ...
                    string path = @"C:\Users\dlyau\OneDrive\Desktop\AnyaProject\Sounds\horseRzhanie.wav";
                    PlaySound(path);

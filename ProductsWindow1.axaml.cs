...
namespace AnyaProject
{
    public partial class ProductsWindow1 : Window
    {
        ...
        {
            SoundPath = @"C:\Users\dlyau\OneDrive\Desktop\AnyaProject\Sounds\Rancho.wav";
        ...
        public ObservableCollection<Product> Products { get; set; } = new ObservableCollection<Product>()
        {
            new Product()
            {
                TovarImage = @"C:\Users\dlyau\OneDrive\Desktop\AnyaProject\Photos\Petlya.jpg",
        ...
        private async void Exit_ButtonClick(object sender, RoutedEventArgs e) //кнопка перехода обратно на окно авторизации
        {
            ...
            SoundPath = @"C:\Users\dlyau\OneDrive\Desktop\AnyaProject\Sounds\horseRzhanie.wav";
            this.PlayMusic(SoundPath);
